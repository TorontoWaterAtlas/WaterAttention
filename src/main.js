...
const waterBodiesData = [
  {
    ...
    yearlyData: {
      2010: 1, 2011: 1, 2012: 8, 2013: 10, 2014: 13, 2015: 12, 2016: 10, 2017: 12,
      2018: 9, 2019: 6, 2020: 5, 2021: 10, 2022: 3, 2023: 7, 2024: 8, 2025: 9
    }
  },
  {
    name: "humberRiver",
  ...
  },
  {
    ...
    yearlyData: {
      2010: 57, 2011: 65, 2012: 55, 2013: 52, 2014: 53, 2015: 51, 2016: 52, 2017: 55,
      2018: 40, 2019: 36, 2020: 33, 2021: 16, 2022: 34, 2023: 40, 2024: 36, 2025: 41
    }
  },
  {
    name: "keatingChannel",
    ...
    yearlyData: {
      2010: 0, 2011: 1, 2012: 0, 2013: 0, 2014: 1, 2015: 1, 2016: 1, 2017: 1,
      2018: 0, 2019: 0, 2020: 1, 2021: 1, 2022: 1, 2023: 1, 2024: 1, 2025: 1
    }
  },
  {
    name: "mimicoCreek",
    ...
    yearlyData: {
      ...
      2018: 1, 2019: 1, 2020: 1, 2021: 1, 2022: 1, 2023: 1, 2024: 1, 2025: 1
    }
  },
  {
    name: "mudCreek",
  ...
  },
  {
    ...
    yearlyData: {
      2010: 0, 2011: 1, 2012: 1, 2013: 1, 2014: 1, 2015: 1, 2016: 1, 2017: 1,
      2018: 1, 2019: 1, 2020: 1, 2021: 1, 2022: 1, 2023: 1, 2024: 1, 2025: 1
    }
  },
  {
    ...
    yearlyData: {
      2010: 0, 2011: 0, 2012: 1, 2013: 1, 2014: 1, 2015: 1, 2016: 1, 2017: 1,
      2018: 1, 2019: 1, 2020: 1, 2021: 1, 2022: 1, 2023: 1, 2024: 1, 2025: 1
    }
  },
  {
...
function createNormalizedFilters(data, config) {
  ...
  console.log(`Google Trends range for current year: ${minTrends} - ${maxTrends}`);
  ...
  data.forEach(item => {
    ...
    console.log(`${item.name}: trends=${item.googleTrends}, radius=${normalizedRadius.toFixed(1)}, strength=${normalizedStrength.toFixed(2)} (${effectType})`);
  });
...
(async () => {
  ...
  app.stage.on("pointerdown", (event) => {
    ...
    if (closestBody && minDistance < 0.1) { // Within reasonable distance
